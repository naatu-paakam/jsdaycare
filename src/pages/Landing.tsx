...
const css = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .diff-vs { display: inline-flex; align-items: center; gap: 6px; font-size: 0.65rem; font-weight: 700; color: var(--gray); background: #f1f5f9; padding: 0.3rem 0.7rem; border-radius: 6px; margin-top: 0.75rem; }
  ...
  return (
    <>
      ...
      <div className="lp-body">
        ...
        {/* Footer */}
        <footer>
          <p>© 2026 NaatuPaakam — built from experience of running a daycare</p>
        </footer>
